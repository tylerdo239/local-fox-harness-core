...
export const vi = {
  ...
  'settings.openrouterKeyTitle': 'OpenRouter API key',
  'settings.openrouterKeyHint': 'Cho phép chọn OpenRouter làm model trong khung chat (nút chọn model cạnh nút Gửi). Lấy key tại',
  'settings.openrouterKeyPlaceholder': 'dán OpenRouter API key…',
  'settings.zaiKeyTitle': 'Z.ai API key',
  'settings.zaiKeyHint': 'Cho phép chọn model GLM của Z.ai (glm-5.3, ...) trong khung chat. Lấy key tại',
  'settings.zaiKeyPlaceholder': 'dán Z.ai API key…',
  ...
  'settings.n8nApiKeyHint': 'Dùng để agent tạo/quản lý workflow n8n. Tạo trong n8n:',
  ...
  // model-picker.tsx
  'modelPicker.currentLabel': '{provider} · {model}',
  'modelPicker.selfHostedGroupLabel': 'Tự triển khai (mặc định)',
  'modelPicker.scopeHint': 'Chỉ áp dụng cho cuộc trò chuyện này, không đổi model mặc định của hệ thống.',
  'modelPicker.mixWarning': 'Đổi model giữa cuộc trò chuyện có thể ảnh hưởng cách agent gọi tool.',
  'modelPicker.providerNotConfiguredToast': 'Chưa cấu hình API key cho {provider} — mở Cài đặt để thêm.',
  'modelPicker.switching': 'Đang đổi model…',
  'modelPicker.switchFailed': 'Không đổi được model',
...
export const en: Record<TranslationKey, string> = {
  ...
  'settings.openrouterKeyTitle': 'OpenRouter API key',
  'settings.openrouterKeyHint': 'Enables picking OpenRouter as a model right in the chat (model button next to Send). Get a key at',
  'settings.openrouterKeyPlaceholder': 'paste your OpenRouter API key…',
  'settings.zaiKeyTitle': 'Z.ai API key',
  'settings.zaiKeyHint': 'Enables picking Z.ai GLM models (glm-5.3, ...) right in the chat. Get a key at',
  'settings.zaiKeyPlaceholder': 'paste your Z.ai API key…',
  'settings.webSearchTitle': 'Serper API key',
  ...
  'settings.n8nApiKeyTitle': 'n8n API key',
  'settings.n8nApiKeyHint': "Used for the agent to create/manage n8n workflows. Create one in n8n:",
  ...
  // model-picker.tsx
  'modelPicker.currentLabel': '{provider} · {model}',
  'modelPicker.selfHostedGroupLabel': 'Self-hosted (default)',
  'modelPicker.scopeHint': 'Applies only to this conversation — does not change the system default model.',
  'modelPicker.mixWarning': 'Switching models mid-conversation can affect how the agent calls tools.',
  'modelPicker.providerNotConfiguredToast': 'API key for {provider} not configured — opening Settings to add it.',
  'modelPicker.switching': 'Switching model…',
  'modelPicker.switchFailed': 'Could not switch model',
