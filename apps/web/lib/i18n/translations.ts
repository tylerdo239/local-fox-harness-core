...
export const vi = {
  ...
  'modelPicker.openrouterNotConfiguredToast': 'Chưa cấu hình OpenRouter API key — mở Cài đặt để thêm.',
...
export const en: Record<TranslationKey, string> = {
  ...
  'modelPicker.openrouterNotConfiguredToast': 'OpenRouter API key not configured — opening Settings to add it.',
